...
If `clacks` warns that the installed skill is outdated, rerun the matching
...
Install writes a full skill bundle: `SKILL.md`, `agents/openai.yaml`,
`LICENSE.txt`, and `.clacks-skill-manifest.json`.
